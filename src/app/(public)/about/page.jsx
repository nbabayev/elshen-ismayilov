...
export default function AboutPage({ params }) {
  ...
  const { ref, inView } = useInView({
    triggerOnce: true, // 👈 Qızıl sətir! True olandan sonra izləməni dayandırır ki, skrol yuxarı-aşağı düşəndə durmadan tetiklenmesin.
    threshold: 0.1, // Blokun 10%-i ekranda görünən kimi işə düşsün
  });
    ...
    <>
        ...
        <div className="grid md:grid-cols-[420px_480px]  grid-cols-[100%] gap-15 mb-20">
          ...
          <div className="font-[lexend]">
            ...
            <p className="text-[#606060]">
              ...
              olan Elşən İsmayılov “Hikmət” Elm və Tədris Mərkəzinin təsisçisi
              və direktoru olmaqla yanaşı, eyni zamanda bu mərkəzdə Fəlsəfə,
              Əqaid, Əxlaq, İslam tarixi, İrfan, Məhdəviyyət, Quran elmləri və
              digər fundamental İslam elmlərini tədris edir.
            </p>
            <p className="font-bold mt-9">Təhsil və elmi-pedaqoji fəaliyyət</p>
            <p className="text-[#606060]">
              Elşən İsmayılov 2010-cu ildə Bakı İslam Universitetində bakalavr
              və magistr təhsilini uğurla başa vurmuş, paralel olaraq fərdi
              şəkildə elmi səviyyəsini inkişaf etdirmişdir. Elmi fəaliyyətinə
              erkən mərhələdə başlamış, müxtəlif tədris müəssisələrində
              çalışaraq ilahiyyat elmlərinin tədrisi sahəsində zəngin təcrübə
              qazanmış, yüzlərlə tələbənin elmi və mənəvi inkişafına töhfə
              vermişdir.
            </p>
            ...
            <p className="text-[#606060]">
              ...
              maarifləndirmə istiqamətində geniş miqyaslı işlər görmüş, təbliğ
              və tədris fəaliyyətini davam etdirmişdir.
            </p>
            ...
            <p className="text-[#606060]">
              ...
              platforma kimi fəaliyyət göstərmişdir. Mərkəz 2023-cü ilə qədər
              həm canlı, həm də virtual dərslərlə yanaşı, seminarlar,
              mühazirələr və elmi tədbirlərin təşkili sahəsində də geniş
              fəaliyyət göstərmiş, 2023-cü ildən sonra isə ancaq virtual
              fəaliyyətini davam etdirmişdi. Hal-hazırda Mərkəz, müasir elmi
              tələblərə cavab verən onlayn tədris imkanlarını təqdim edir.
              Mərkəzdə tədris fəaliyyəti ilə yanaşı, elmi təhlillər aparılır,
              dərs vəsaitləri hazırlanır, həmçinin dini və fəlsəfi əsərlər
              yazılır və tərcümə olunur. Bu istiqamətdə görülən işlər, yalnız
              bilik ötürmək deyil, həm də elmi ədəbiyyatın zənginləşdirilməsi və
              tənqidi düşüncə mədəniyyətinin inkişafı baxımından xüsusi
              əhəmiyyət daşıyır. Mərkəz, daim yenilənən metodlara əsaslanaraq
              tələbələrə müasir və çevik tədris mühiti təqdim etməyi qarşısına
              məqsəd qoymuşdur. Tədrisin keyfiyyəti, tələbə məmnuniyyəti və elmi
              yeniliklərə açıq yanaşma Hikmət Mərkəzinin əsas prinsiplərindən
              biridir.
            </p>
            ...
            <p className="text-[#606060] mt-9">
              ...
              qurulmuşdur. O, dini mətnləri yalnız ənənəvi şərhlərlə deyil, həm
              də müasir düşüncə tələblərinə cavab verən təhlil metodları ilə
              izah edərək, onları həyatın aktual problemləri ilə əlaqələndirir.
            ...
            <p className="text-[#606060] mt-7">
              Bu sayt vasitəsilə Elşən İsmayılovun aşağıdakı sahələri ehtiva
              edən çoxşaxəli fəaliyyəti ilə tanış ola bilərsiniz:
            </p>
            <p className="text-[#606060] mt-7">
              Müxtəlif mövzularda keçdiyi dərslər;
            </p>
            <p className="text-[#606060] mt-7">
              Eləcə də Cümə xütbələri, həmçinin Ramazan və Məhərrəm aylarına
              dair silsilə xütbələr.
            </p>
            <p className="text-[#606060] mt-7">
      ...
      <div className="mt-15">
        <Section
          ...
          content={<ArticleDataUI data={articles} />}
        />
      </div>
    </>
  );

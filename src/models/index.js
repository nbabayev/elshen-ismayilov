...
const Settings = sequelize.define(
  "Settings",
  {
    ...
    SubscribeImage: { type: DataTypes.STRING, allowNull: true },
    SubscribeTitle: { type: DataTypes.STRING, allowNull: true },
    SubscribeSignature: { type: DataTypes.STRING, allowNull: true },
    ...
    ShowStats: { type: DataTypes.BOOLEAN, allowNull: true },
